    ...
    var chart = AmCharts.makeChart("chartdiv3", {
        ...
        "graphs": [{
            ...
            },
            {
                ...
                "stackable": false,
                "bulletColor": "#76c5c1",
                "bulletBorderColor": "#29aba4",
                "bulletBorderThickness": 3,
                "balloonText": "<div style='margin-bottom:30px;text-shadow: 2px 2px rgba(0, 0, 0, 0.1); font-weight:200;font-size:30px; color:#1d8a84'>[[value]]</div>"
            }
        ],
        "chartCursor": {
            "cursorAlpha": 1,
