...
public partial class franchisee_DepositRequstAddRetailer : System.Web.UI.Page
{
                    ...
                    if (Convert.ToDecimal(txtamount.Text) >= 1000.00M)
                        {
                            ...
                            string rs = objaccount.Direct_DepositRequestByUserFromFranchisee(objaccount);       //      will be approved automatically, whenever franchisee made a request of user to himself.
                            //string rs = "t";
                            if (rs == "t")
                            {
