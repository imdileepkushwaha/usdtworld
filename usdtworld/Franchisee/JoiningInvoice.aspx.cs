        ...
        //    {
               ...
               if (DT != null && DT.Rows.Count > 0)
               {
                   ...
                   if (UDT != null && UDT.Rows.Count > 0)
                   {
                       ...
                       LblBillingAddress.Text = UDT.Rows[0]["shippingaddress"].ToString();
                       LblBillingPost.Text = UDT.Rows[0]["shippingareaname"].ToString();
                       LblBillingCity.Text = UDT.Rows[0]["cityname"].ToString();
                       LblBillingState.Text = UDT.Rows[0]["statename"].ToString();
                       LblBillingPincode.Text = UDT.Rows[0]["shippingpincode"].ToString();
