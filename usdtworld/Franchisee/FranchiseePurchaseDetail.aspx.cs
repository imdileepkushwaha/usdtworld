...
public partial class FranchiseePurchaseDetail : System.Web.UI.Page
{
    ...
    {
        string str_query = "SELECT P.PurchaseID,P.FranchiseeID,V.username,P.PurchaseAmount,P.CGST,P.SGST,P.IGST,P.TotalAmount,Convert(Char,P.PurchaseDate,103) as PurchaseDate,P.orderNo,P.Cash,P.restamount,P.paymentmode,P.chequeNo,case when P.Status=0 then 'Pending' when P.Status=1 then 'Approved' else 'Reject' end as Status1  FROM FranchiseePurchaseMaster P INNER JOIN FranchiseeDetail V ON P.FranchiseeID=V.userid where 1=1 ";
