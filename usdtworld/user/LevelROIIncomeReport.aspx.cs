...
public partial class LevelROIIncomeReport : System.Web.UI.Page
{
    ...
    {
        string str_query = "SELECT I.Userid,U.UserName,I.amount,Convert(VARCHAR(50),I.Mentiondate,103) PaymentDate,I.MentionBy AS fromuserid,ud3.UserName AS Fromusername FROM roidetail I JOIN UserDetail U ON I.Userid=U.UserId  JOIN userdetail ud3 ON ud3.UserId=I.MentionBy   where 1=1 AND ROIType='LevelROI' AND I.Amount>0  ";
