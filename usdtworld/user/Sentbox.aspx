<%@ Page Title="Sentbox" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Sentbox.aspx.cs" Inherits="Associate_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <div class="sv-dashboard-page sv-messages-page">
        ...
        <div class="sv-dash-header">
            ...
            <div class="sv-dash-header__main">
                ...
                <div class="sv-dash-header__text">
                    ...
                    <h1>Sent Box</h1>
                    <p>Messages you have sent to support</p>
                </div>
            </div>
        ...
        <nav class="sv-msg-tabs" aria-label="Message sections">
            ...
            <a href="Sentbox.aspx" class="sv-msg-tabs__item sv-msg-tabs__item--active">
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentpageData" runat="Server">
    <div class="sv-dashboard-page sv-messages-page">
        ...
        <asp:Panel ID="pnllist" runat="server" Visible="false">
            <div class="sv-panel">
                <div class="sv-panel__head">
                    <h6><i class="fa-solid fa-paper-plane" style="margin-right:8px;color:#a5b4fc;"></i>Sent Messages</h6>
                    <span>Sent Box</span>
                </div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="sv-msg-table table table-borderless" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" GridLines="None">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="To">
                                    <ItemTemplate>
                                        <span class="sv-msg-from"><%# Eval("ToId") %></span>
                                        <asp:Label ID="lblfromid" runat="server" Visible="false" Text='<%# Eval("ToId") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <asp:Panel ID="pnlEmpty" runat="server" Visible="false" CssClass="sv-msg-empty">
            ...
            <p>You have not sent any messages yet. Start a conversation with support.</p>
        ...
        <asp:Panel ID="pnlModal" Visible="false" runat="server" CssClass="sv-msg-modal">
            ...
            <div class="sv-msg-modal__head">
                <div class="sv-msg-modal__head-main">
                    <span class="sv-msg-modal__icon"><i class="fa-solid fa-paper-plane"></i></span>
                    <div>
                        <span class="sv-msg-modal__eyebrow">Sent Message</span>
                ...
                <div class="sv-msg-detail">
                    <div class="sv-msg-detail__item">
                        ...
                        <div class="sv-msg-detail__content">
                            <span class="sv-msg-detail__label">To</span>
