...
public partial class User_test : System.Web.UI.Page
{
    ...
    void loadbinary(string str_superid,string str_poolno)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                ltuser1.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/green.png"" style=""height:70px;"" /></a>";
         
            }
            else
            {
                ltuser1.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/red.png"" style=""height:70px;"" /></a>";
            }
            ...
            if (dt2.Rows.Count > 0)
            {
                ...
                {
                    ltuser2.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt2.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt2.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/green.png"" style=""height:70px;"" /></a>";
                }
                else
                {
                    ltuser2.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt2.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt2.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/red.png"" style=""height:70px;"" /></a>";
                }
            ...
            if (dt3.Rows.Count > 0)
            {
                ...
                {
                    ltuser3.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt3.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt3.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/green.png"" style=""height:70px;"" /></a>";
                }
                else
                {
                    ltuser3.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt3.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt3.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/red.png"" style=""height:70px;"" /></a>";
                }
            ...
            if (dt4.Rows.Count > 0)
            {
                ...
                {
                    ltuser4.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt4.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt4.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/green.png"" style=""height:70px;"" /></a>";
                }
                else
                {
                    ltuser4.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt4.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt4.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/red.png"" style=""height:70px;"" /></a>";
                }
            ...
            if (dt5.Rows.Count > 0)
            {
                ...
                {
                    ltuser5.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt5.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt5.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/green.png"" style=""height:70px;"" /></a>";
                }
                else
                {
                    ltuser5.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt5.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt5.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/red.png"" style=""height:70px;"" /></a>";
                }
            ...
            if (dt6.Rows.Count > 0)
            {
                ...
                {
                    ltuser6.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt6.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt6.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/green.png"" style=""height:70px;"" /></a>";
                }
                else
                {
                    ltuser6.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt6.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt6.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/red.png"" style=""height:70px;"" /></a>";
                }
            ...
            if (dt7.Rows.Count > 0)
            {
                ...
                {
                    ltuser7.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt7.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt7.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/green.png"" style=""height:70px;"" /></a>";
                }
                else
                {
                    ltuser7.Text = @"<a href='testAutoPool.aspx?SuperId=" + dt7.Rows[0]["Userid"].ToString() + @"'  data-html=""true""   class='showpopover'  data-content=""" + getBinarydata(dt7.Rows[0]["Userid"].ToString()) + @""" rel=""popover"" data-placement=""bottom"" data-original-title=""Binary Details"" data-trigger=""hover""  ><img src=""img/red.png"" style=""height:70px;"" /></a>";
                }
