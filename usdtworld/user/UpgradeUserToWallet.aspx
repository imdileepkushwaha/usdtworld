<%@ Page Title="" Language="C#" MasterPageFile="masterpage.master" AutoEventWireup="true" CodeFile="UpgradeUserToWallet.aspx.cs" Inherits="user_ActivateUserToWallet" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border text-light">
                            <h3 class="box-title">Upgrade User With Wallet </h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Amount :</label>
                                        <asp:TextBox ID="txtamount" Text="" Enabled="false" CssClass="form-control" runat="server" AutoPostBack="true" OnTextChanged="txtamount_TextChanged"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
