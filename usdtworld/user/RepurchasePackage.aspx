<%@ Page Title="" Language="C#" MasterPageFile="~/user/usermaster.master" AutoEventWireup="true" CodeFile="RepurchasePackage.aspx.cs" Inherits="user_RepurchasePackage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
     <section class="content-header">
        <h1>Repurchase Package
        </h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="#">Repurchase Package</a></li>
            <li class="active">Repurchase Package  </li>
                                    ...
                                    <div class="form-group">
                                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" DataKeyNames="PurchaseID">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Repurchase Price">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Net Value">
                                                   ...
                                                   <asp:TemplateField HeaderText="RBV">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblJBV" runat="server" Text='<%#Eval("RBV") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
