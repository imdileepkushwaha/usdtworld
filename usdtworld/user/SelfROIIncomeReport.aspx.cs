...
public partial class LevelROIIncomeReport : System.Web.UI.Page
{
    ...
    {
        string str_query = "SELECT I.Userid,U.UserName,I.amount,Convert(VARCHAR(50),I.Mentiondate,103) PaymentDate FROM roidetail I JOIN UserDetail U ON I.Userid=U.UserId where 1=1 AND ROIType='Normal' ";
