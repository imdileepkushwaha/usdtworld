...
public partial class AutoPoolIncomeReport : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        ...
        //}
        DataTable Dt = getPoolClosingReport(objCL);
    ...
    public DataTable getPoolClosingReport(clsClosing objCL)
    {
        ...
        {
            str_query += "  and cast( p.MentionDate   as date)  >= cast('" + objCL.Fromdate + "' as date)   and cast( p.MentionDate  as date)    <= cast('" + objCL.Todate + "' as date)  ";
        }
