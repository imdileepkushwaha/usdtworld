<%@ Page Title="Deposit Request Report" Language="C#" MasterPageFile="masterpage.master" AutoEventWireup="true" CodeFile="TopupRequestReport.aspx.cs" Inherits="admin_TopupRequestReport" %>
   ...
   <section class="content-header">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>/</li>
                <li class="fw-medium">Topup Request Report</li>
            </ul>
        </div>
    </section>  
</asp:Content>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <asp:TemplateField HeaderText="User Id">
                                        <ItemTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Downline Id">
                                        <ItemTemplate>
