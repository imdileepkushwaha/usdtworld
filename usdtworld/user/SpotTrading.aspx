...
<asp:Content ID="Content3" ContentPlaceHolderID="contentpageData" runat="Server">
    ...
    <div class="sv-dashboard-page sv-spot-page">
        ...
        <section class="sv-spot-hero" aria-live="polite">
                ...
                <div class="sv-spot-hero__left">
                    <div class="sv-spot-hero__pair">
                        ...
                        <div class="sv-spot-hero__pair-text">
                            ...
                            <span class="sv-spot-hero__sub" id="svSpotIntervalLabel"><i class="fa-solid fa-chart-line"></i> Utility coin · 1m candles</span>
                        </div>
                    </div>
                </div>

                <div class="sv-spot-hero__center">
                    <div class="sv-spot-hero__price-block">
                        <span class="sv-spot-hero__price-label">Last Traded Price</span>
                        ...
                        <span class="sv-spot-hero__price-hint"><i class="fa-solid fa-arrows-rotate"></i> Auto-refresh every minute</span>
                    </div>
                </div>

                <div class="sv-spot-hero__right">
                    <div class="sv-spot-hero__metric">
                        <span class="sv-spot-hero__metric-label"><i class="fa-solid fa-arrow-trend-up"></i> 24h High</span>
                        <strong id="svSpotHigh" class="sv-spot-hero__metric-value sv-spot-hero__metric-value--high">$0.00042000</strong>
                    </div>
                    <div class="sv-spot-hero__metric">
                        <span class="sv-spot-hero__metric-label"><i class="fa-solid fa-arrow-trend-down"></i> 24h Low</span>
                        <strong id="svSpotLow" class="sv-spot-hero__metric-value sv-spot-hero__metric-value--low">$0.00013500</strong>
                    </div>
                </div>
            </div>

            <div class="sv-spot-hero__footer">
                <div class="sv-spot-hero__footer-item">
                    <span class="sv-spot-hero__footer-icon"><i class="fa-solid fa-rocket"></i></span>
                    <div class="sv-spot-hero__footer-text">
                        <span class="sv-spot-hero__footer-label">Launch Price</span>
                        <strong class="sv-spot-hero__footer-value">$0.000139</strong>
                    </div>
                </div>
                <div class="sv-spot-hero__footer-divider" aria-hidden="true"></div>
                <div class="sv-spot-hero__footer-item">
                    <span class="sv-spot-hero__footer-icon"><i class="fa-solid fa-chart-line"></i></span>
                    <div class="sv-spot-hero__footer-text">
                        <span class="sv-spot-hero__footer-label">Since Launch</span>
                        <strong id="svSpotLaunchGain" class="sv-spot-hero__footer-value sv-spot-hero__footer-value--up">+0.00%</strong>
                    </div>
                </div>
                <div class="sv-spot-hero__footer-divider" aria-hidden="true"></div>
                <div class="sv-spot-hero__footer-item">
                    <span class="sv-spot-hero__footer-icon"><i class="fa-regular fa-clock"></i></span>
                    <div class="sv-spot-hero__footer-text">
                        <span class="sv-spot-hero__footer-label">Last Update</span>
                        <strong id="svSpotUpdated" class="sv-spot-hero__footer-value">--:--</strong>
                    </div>
                </div>
                <div class="sv-spot-hero__footer-divider sv-spot-hero__footer-divider--hide-sm" aria-hidden="true"></div>
                <div class="sv-spot-hero__footer-item sv-spot-hero__footer-item--accent">
                    <span class="sv-spot-hero__footer-icon"><i class="fa-solid fa-bolt"></i></span>
                    <div class="sv-spot-hero__footer-text">
                        <span class="sv-spot-hero__footer-label">Market Status</span>
                        <strong class="sv-spot-hero__footer-value sv-spot-hero__footer-value--live">Open</strong>
                    </div>
                </div>
            </div>
                ...
                <div class="sv-spot-side-stack">
                    ...
                    <div class="sv-panel sv-spot-order-panel">
                        ...
                        <div class="sv-panel__body sv-spot-order-panel__body">
                            ...
                            <div class="sv-spot-order-tabs" role="tablist">

                                <button type="button" class="sv-spot-order-tabs__btn sv-spot-order-tabs__btn--buy is-active" data-side="buy">

                                    <i class="fa-solid fa-arrow-trend-up"></i> Buy

                                </button>

                                <button type="button" class="sv-spot-order-tabs__btn sv-spot-order-tabs__btn--sell" data-side="sell">
                            ...
                            <div class="sv-spot-order-form">
                                ...
                                <label class="sv-spot-field">
                                    ...
                                    <span class="sv-spot-field__row">
                                        ...
                                        <span id="svSpotAmountLabel" class="sv-spot-field__label">Amount</span>

                                        <span id="svSpotAmountUnit" class="sv-spot-field__unit">USDT</span>

                                    </span>

                                    <div class="sv-spot-input-wrap">

                                        <input type="number" id="txtSpotAmount" class="form-control sv-spot-input" min="0" step="any" placeholder="0.00" />
                                ...
                                <div class="sv-spot-quick-amt">
                                    ...
                                    <button type="button" class="sv-spot-quick-amt__btn" data-pct="25">25%</button>

                                    <button type="button" class="sv-spot-quick-amt__btn" data-pct="50">50%</button>

                                    <button type="button" class="sv-spot-quick-amt__btn" data-pct="75">75%</button>

                                    <button type="button" class="sv-spot-quick-amt__btn" data-pct="100">Max</button>
                                ...
                                <div class="sv-spot-receive-box">
                                    ...
                                    <span id="svSpotReceiveLabel">You receive</span>

                                    <strong id="svSpotReceive">0 UWC+</strong>

                                </div>



                                <p id="svSpotOrderMsg" class="sv-spot-order-msg"></p>



                                <button type="button" id="btnSpotSubmit" class="sv-spot-submit sv-spot-submit--buy">
