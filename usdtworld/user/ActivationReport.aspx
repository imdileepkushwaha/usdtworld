<%@ Page Title="Transaction Report" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ActivationReport.aspx.cs" Inherits="admin_UserReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Activation Report</h6>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Description">
                                                  ...
                                                  <asp:TemplateField HeaderText="Roi Type">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblroitype" runat="server" Text='<%#Eval("ROI_Type") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
