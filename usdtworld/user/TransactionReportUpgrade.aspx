<%@ Page Title="Transaction Report(Upgrade Wallet)" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="TransactionReportUpgrade.aspx.cs" Inherits="admin_UserReport" %>
            ...
            <div class="sv-account-page sv-report-page">
                <div class="sv-page-header sv-page-header--report">
                    ...
                    <div class="sv-page-header__main">
                        ...
                        <div class="sv-page-header__text">
                            <h1>Transaction Report(Upgrade Wallet)</h1>
                    ...
                    <div class="sv-page-header__actions">
                        ...
                        <span class="sv-page-header__crumb">Reports / Transaction Report(Upgrade Wallet)</span>
                    </div>
                </div>
                ...
                <div class="sv-form-card">
                    <div class="sv-form-card__head">
                        ...
                        <div class="sv-form-card__head-text">
                            <h3>Transaction Details(Upgrade Wallet)</h3>
