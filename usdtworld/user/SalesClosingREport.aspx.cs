...
public partial class SalesClosingREport : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        ...
        DataTable Dt = objCL.getClosingReportSales(Fromdate, Todatedate, TxtUserId.Text);
