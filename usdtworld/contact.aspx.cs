...
public partial class Contact : System.Web.UI.Page
{
    ...
    public bool userMail(string username, string title, string description, string useremail, string mobile)
    {
        ...
        //
        string Subject2 = "Query From Website";
        string Body2 = "USer Name :  " + username + ",<br><br>  <br><br>Title :-" + title + " <br> Mobile :-" + mobile + "<br> <br>  Email :-" + useremail + "<br> <br> Your Query :-" + description + "<br><br> ";
        //
        ...
        mail.From = new MailAddress("info@socialvista.trade");
        mail.Subject = Subject2;
        mail.Body = Body2;

        mail.IsBodyHtml = true;

        SmtpClient smtp = new SmtpClient("smtp.titan.email", 587);
        smtp.EnableSsl = true;
        smtp.UseDefaultCredentials = false;
       // SmtpClient smtp = new SmtpClient("smtp.titan.email", 465);
       // smtp.EnableSsl = true;
      //  smtp.UseDefaultCredentials = false;
        //smtp.Credentials = new NetworkCredential("info@socialvista.trade", "DeepakTrade@123");
           smtp.Credentials = new System.Net.NetworkCredential("info@socialvista.trade", "DeepakTrade@123");
