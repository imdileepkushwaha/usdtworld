 ...
 **************************************************************** **/
	function _toggle() {
		...
		jQuery("div.toggle > label").on(function(e) {
 ...
 **************************************************************** **/
	function _misc() {
		 ...
		 *********************** **/
		jQuery(".incr").on("click", function(e) {
			e.preventDefault();
		...
		jQuery(".decr").on("click", function(e) {
			e.preventDefault();
 ...
 **************************************************************** **/
	function _goFullScreen() {
		...
		jQuery("#goToFullScreen").on("click", function(e) {
			e.preventDefault();
 ...
 **************************************************************** **/
	function _panels() {
		...
		// Panel Collapse
		jQuery('#middle div.panel ul.options>li>a.panel_colapse').on("click", function(e) {
			e.preventDefault();
		...
		// Panel Close
		jQuery('#middle div.panel ul.options>li>a.panel_close').on("click", function(e) {
			e.preventDefault();
		...
		// Panel Fullscreen
		jQuery('#middle div.panel ul.options>li>a.panel_fullscreen').on("click", function(e) {
			e.preventDefault();
	...
	function _modalAutoLoad() {
		if(jQuery("div.modal").length > 0) {
			...
			jQuery("div.modal").each(function() {
				...
				jQuery("input.loadModalHide", this).on("click", function() {
					var _tt = jQuery(this);
