...
public partial class ClosingReferalReport : System.Web.UI.Page
{
    ...
    void loaduser()
    {
        ...
        dt = objCL.getClosingDate("REFERALBONUS");
    ...
    void loaddata()
    {
        string Fromdate = "";
        string Todatedate = "";
        string UserId = string.Empty;// txtuserid.Text;
       ...
       // objaccount.UserId = txtuserid.Text;
        ...
        DataTable Dt = objCL.getClosingReport(Fromdate, Todatedate, UserId, "REFERALBONUS");
