<%@ Page Title="Generate Closing" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="CalculateRepurchaseClosing.aspx.cs" Inherits="CalculateRepurchaseClosing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
     <section class="content-header">
      <h1>
      Generate Repurchase Closing 
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Closing</a></li>
        <li class="active">Generate Repurchase Closing</li>
      </ol>
    </section>    
</asp:Content>
