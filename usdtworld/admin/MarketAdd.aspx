<%@ Page Title="Add Market" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="MarketAdd.aspx.cs" Inherits="MarketAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <script type="text/javascript">
         ...
         function validate() {
             ...
             if (document.getElementById("<%=Txtmarket.ClientID%>").value == "") {

                 alert('Enter Market');
                 // alert("Enter Rank No"); 
                 document.getElementById("<%=Txtmarket.ClientID%>").focus();
                   return false;
               }
           }
           function validate2() {
 ...
 <div class="row">
     <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Add Market</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                 ...
                 <div class="box-body">
                     ...
                     <div class="row">
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label>City</label>
                                 <asp:DropDownList ID="ddlstcity" CssClass="form-control" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="ddlstcity_SelectedIndexChanged" >
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                  <label>Tehsil</label>
                                  <asp:DropDownList ID="ddlsttehsil" CssClass="form-control" runat="server" >
                      ...
                      <div class="row">
                         <div class="col-md-6">
                             <div class="form-group">
                                <label>Market</label>
                                 <asp:TextBox ID="Txtmarket" CssClass="form-control" runat="server"></asp:TextBox>
                             </div>
                         </div>
                         <div class="col-md-6">
                             <div class="form-group">
                  ...
                  <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand"  >
                                ...
                                <asp:TemplateField HeaderText="#">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblid" runat="server" Visible="false" Text='<%#Eval("MarketId") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Market Details</h4>
                    </div>
