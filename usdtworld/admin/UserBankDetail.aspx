<%@ Page Title="Edit User Details" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="UserBankDetail.aspx.cs" Inherits="UserBankDetail" %>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>UPI ID</label>
                                        <asp:TextBox ID="txtupiid" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                            </div>   
                        </div>
