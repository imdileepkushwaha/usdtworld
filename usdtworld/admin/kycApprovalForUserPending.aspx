<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="kycApprovalForUserPending.aspx.cs" Inherits="kycApprovalForUserPending" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sign Up Form" Visible="false">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Sign Up Status" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSignUpStatus" runat="server" Text='<%# Eval("SignUpImgStatuss") %>' CssClass='<%# Eval("SignUpImgStatuss") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Action for Sign Up" Visible="false">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Action for Cheque">
                                     ...
                                     <asp:TemplateField HeaderText="Adhar Number">
                                        <ItemTemplate>
                                            <asp:Label ID="lbladhar" runat="server" Text='<%#Eval("adharnumber") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
