<%@ Page Title="Deposit Request" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="franchiseeDepositRequstAdd.aspx.cs" Inherits="franchiseeDepositRequstAdd" %>
                        ...
                        <div class="row" style="display:none;">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:RadioButton ID="RDBtnTRecharge" runat="server" Text="Recharge Wallet" GroupName="A" AutoPostBack="true"  />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:RadioButton ID="RdBtnUtility" runat="server" Text="Utility Wallet" GroupName="A" AutoPostBack="true"  />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                </div>
