<%@ Page Title="Purchase Report" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="FranchiseePvReport.aspx.cs" Inherits="FranchiseePvReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
     ...
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active">Franhchisee PV Report </li>
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                                 <label>Franchisee :</label>
                                    <asp:DropDownList ID="DDLstFranchisee" CssClass="form-control"  runat="server"></asp:DropDownList>
                             </div>
                         </div>
