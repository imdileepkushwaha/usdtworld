<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="TransferReferalRepurchase.aspx.cs" Inherits="TransferReferalRepurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
  <section class="content-header">
      <h1>
       Transfer Referal/Repurchase Closing     
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Closing</a></li>
        <li class="active">Transfer Referal/Repurchase Closing</li>
      </ol>
    </section>  
</asp:Content>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-footer">
                            ...
                            &nbsp;
                             <asp:Button ID="btnpay"  CssClass="btn btn-primary" runat="server" Text="Pay" OnClick="btnpay_Click" Visible="false" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="To Date">
                                     ...
                                     <asp:TemplateField HeaderText="User Name">
                                       ...
                                       <asp:TemplateField HeaderText="Referal Incentive">
                                        <ItemTemplate>
                                            <asp:Label ID="lblyincentive" runat="server" Text='<%#Eval("ReferalIncome") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Repurchase Incentive">
                                        <ItemTemplate>
                                            <asp:Label ID="lbltincentive" runat="server" Text='<%#Eval("RepurchaseIncome") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Total Incentive">
                                        <ItemTemplate>
                                            <asp:Label ID="lbltindcentive" runat="server" Text='<%#Eval("TotalIncentive") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Capping Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCappingAmount" runat="server" Text='<%#Eval("CappingAmount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>  
                                     <asp:TemplateField HeaderText="Difference Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDifferenceAmount" runat="server" Text='<%#Eval("DifferenceAmount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                                     
                                        <asp:TemplateField HeaderText="Net Incentive">
                                        <ItemTemplate>
                                            <asp:Label ID="lblincentive" runat="server" Text='<%#Eval("Commission") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
