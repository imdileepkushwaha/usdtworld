<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="CoreCommitteePayout.aspx.cs" Inherits="admin_CoreCommitteePayout" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
     <section class="content-header">
        <h1>Core Committee Payout
        </h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="#">Closing</a></li>
            <li class="active">Core Committee Payout </li>
        </ol>
    </section>
</asp:Content>
            ...
            <div class="row">
                <div class="col-md-12">
                   <%-- <div class="box box-primary">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Core Committee Payout Details</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:GridView ID="gvusers" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" OnRowCommand="gvusers_RowCommand" OnRowDataBound="gvusers_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Status">
                                                  ...
                                                  <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                      <asp:LinkButton ID="lbpay" CommandName="pay" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" runat="server" CssClass="btn btn-primary">Pay</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>                                                    
                                            </Columns>
                                        </asp:GridView>
