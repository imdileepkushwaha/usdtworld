<%@ Page Title="Level Master" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="SalesLevelMaster.aspx.cs" Inherits="SalesLevelMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
    <section class="content-header">
     ...
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active">Sales Level master</li>
      </ol>
    </section>   
</asp:Content>
              ...
              <div class="box-body">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" >
                           ...
                           <asp:TemplateField HeaderText="Level">
                               ...
                               <ItemTemplate>
                                   <asp:TextBox ID="txtrcomission" CssClass="form-control" Text='<%#Eval("RechargeCommssion") %>'  runat="server"></asp:TextBox>
                               </ItemTemplate>
                                        </asp:TemplateField>
                                      <asp:TemplateField HeaderText="DTH Booking Comm" Visible="false">
                               <ItemTemplate>
                                   <asp:TextBox ID="txtdcomission" CssClass="form-control" Text='<%#Eval("DTHCommission") %>'  runat="server"></asp:TextBox>
                               </ItemTemplate>
                                        </asp:TemplateField>
                            </Columns>
                            </asp:GridView>
