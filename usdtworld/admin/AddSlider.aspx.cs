...
public partial class admin_AddSlider : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        try
        {
            ...
            DataTable dt = con.ExecuteDataSet("Pro_Slider", arr);
    ...
    protected void ImageUpload(string Agentid)
    {
        try
        {
            ...
            {
                FileUpload1.SaveAs(Server.MapPath("~/user/Slider//" + Agentid + ext));
            }
            else
            {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt1 = con.ExecuteDataSet("Pro_Slider", arr1);
            ...
            if (FileUpload1.HasFile)
            {
                ...
                {
                    filepath = ("~/user/Slider/" + id + Path.GetExtension(FileUpload1.FileName));
                }
            ...
            if (con.ExecuteNonQueryStoredProcedure("Pro_Slider", arr))
            {
                if (FileUpload1.HasFile)
                {
    ...
    protected void btn_update_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                if (FileUpload1.HasFile && (ext == ".jpg" || ext == ".JPG" || ext == ".JPEG" || ext == ".jpeg" || ext == ".png" || ext == ".PNG" || ext == ".gif" || ext == ".gif"))
                {
                    filepath = ("~/user/Slider/" + HiddenField2.Value.ToString() + Path.GetExtension(FileUpload1.FileName));
                }
    ...
    protected void btndelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = con.ExecuteDataSet("Pro_Slider", arr2);
