<%@ Page Title="Single Leg Income Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="SIngleLegIncomeReport.aspx.cs" Inherits="LevelIncomeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
     ...
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home > </a></li>
        ...
        <li class="active">Single Leg Income </li>
                               ...
                               <Columns>
                                    <asp:TemplateField HeaderText="#">
                                     ...
                                     <asp:TemplateField HeaderText="Username">
                                       ...
                                       <asp:TemplateField HeaderText="Plan">
                                        <ItemTemplate>
                                            <asp:Label ID="lblusplanername" runat="server" Text='<%#Eval("planname") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Total Income">
                                       ...
                                       <asp:TemplateField HeaderText="Closing Date">
                                        <ItemTemplate>
                                            <asp:Label ID="lblclosingdDate" runat="server" Text='<%#Eval("closingDate") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>         
