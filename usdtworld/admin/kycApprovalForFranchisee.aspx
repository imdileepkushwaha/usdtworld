<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="kycApprovalForFranchisee.aspx.cs" Inherits="admin_kycApprovalForFranchisee" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action for PAN">
                                        <ItemTemplate>
                                            ...
                                            &nbsp;
                                            <asp:LinkButton ID="lnkRejectPan" runat="server" OnClientClick="return confirm('Sure to Reject PAN Card?');" Text="Reject" CommandName="reject_pan" CommandArgument='<%#Eval("userid") %>' 
                                                Visible='<%# Eval("PanImage").ToString() != "" ? Eval("PanImgStatuss").ToString() == "Pending" ? true : false : false %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
