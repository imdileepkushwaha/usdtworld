...
public partial class ClosingAward : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        ...
        {
            Fromdate = DDlstFromdate.SelectedValue;
            Todatedate = DDlstFromdate.SelectedValue;
        }
        DataTable Dt = objCL.getAwardClosingReport(Fromdate, TxtUserId.Text);
