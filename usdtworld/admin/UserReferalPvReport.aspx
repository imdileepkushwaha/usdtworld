<%@ Page Title="Purchase Report" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="UserReferalPvReport.aspx.cs" Inherits="UserReferalPvReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
      <h1>
          User Referal PV Report
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Accounts</a></li>
        <li class="active">User Referal PV Report </li>
                   ...
                   <div class="box-body">
                        ...
                        <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <asp:TextBox ID="txtFuserid"  CssClass="form-control" runat="server"></asp:TextBox>
                             </div>
                            </div>
                                 <div class="col-md-4">
                             ...
                             <div class="form-group">
                               ...
                               <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="From User Id">
                                        <ItemTemplate>
                                            <asp:Label ID="lbluserid1235" runat="server" Text='<%#Eval("FromUserID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
