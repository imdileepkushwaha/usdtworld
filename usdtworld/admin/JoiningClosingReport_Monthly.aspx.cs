...
public partial class JoiningClosingReportMonth : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        ...
        DataTable Dt = objCL.getJoiningClosingReportMonth(Fromdate, Todatedate, TxtUserId.Text);
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=userpurchase.xls");
        Response.Charset = "";
