...
public partial class user_DHTBookingdetailaspx : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        Label Lblliveid = (Label)GridView1.Rows[index].FindControl("lbLiveID");
        ...
        else
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = objS.UpdateRechargeStatusManual(lbltransactionid.Text, str_status, Session["useradmin"].ToString(), Lblliveid.Text);
                loaduser();
            }
        }
    ...
    {
        DataTable dt = new DataTable();
        dt = objS.UpdateRechargeStatusManual(LblRefrtenceId.Text, "Success", Session["useradmin"].ToString(), txtliveid.Text);
