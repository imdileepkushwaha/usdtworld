<%@ Page Title="Level Master" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="SelfPurchaseBonusmaster.aspx.cs" Inherits="SelfPurchaseBonusmaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
    <section class="content-header">
      <h1>
       Self Purchase master     
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Utility management</a></li>
        <li class="active">Self Purchase master </li>
      </ol>
    </section>   
</asp:Content>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" >
                           ...
                           <asp:TemplateField HeaderText="Direct Count">
                               <ItemTemplate>
                                     <asp:Label ID="lbllevel" runat="server"  Text='<%#Eval("Fromid") %>'></asp:Label>
                               </ItemTemplate>
                           </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Bonus %">
                               <ItemTemplate>
                                   <asp:TextBox ID="txtcomission" CssClass="form-control" Text='<%#Eval("Bonus") %>'  runat="server"></asp:TextBox>
                               </ItemTemplate>
                                        </asp:TemplateField>
                            </Columns>
                            </asp:GridView>
