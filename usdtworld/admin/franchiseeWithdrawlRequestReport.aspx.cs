...
public partial class franchiseeWithdrawlRequestReport : System.Web.UI.Page
{
    ...
    void loadgethelp()
    {
        ...
        dt = objaccount.getWithdrawlRequestfranchisee(objaccount);
    ...
    protected void btnApprove_click(object sender, EventArgs e)
    {
        ...
        string res = objaccount.Approve_WithdrawlRequestfranchisee(objaccount);
        if (res == "t")
        {
            ...
            if (res == "f")
            {
                string popupScript = "alert('User have insufficient balance in current');";
                ScriptManager.RegisterStartupScript(UpdatePanel1, UpdatePanel1.GetType(), Guid.NewGuid().ToString(), popupScript, true);
            }
            else
            {
    ...
    protected void btnReject_click(object sender, EventArgs e)
    {
        ...
        objaccount.WithdrawlRequestId = lblgalleryid.Text;
        objaccount.MentionBy = Session["useradmin"].ToString();
        string res = objaccount.Reject_WithdrawlRequest(objaccount);
        if (res == "t")
        {
