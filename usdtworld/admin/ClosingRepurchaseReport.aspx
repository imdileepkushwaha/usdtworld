<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="ClosingRepurchaseReport.aspx.cs" Inherits="ClosingRepurchaseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
  <section class="content-header">
     ...
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active">Repurchase Closing Report</li>
      </ol>
    </section>  
</asp:Content>
