...
public partial class CalculateReferalClosing : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                //TxtFromdate.Text = objCl.GetClosingDate("REFERALBONUS").ToString("dd/MMM/yyyy");
                TxtFromdate.Text = objCl.GetClosingDate("REFERALREPURCHASE").ToString("dd/MMM/yyyy");
            }
            else
            {
    ...
    {
        //int h = objCl.CalculateClosingNew(TxtTodate.Text, "REFERALBONUS");
        int h = objCl.CalculateClosingNew(TxtTodate.Text, "REFERALREPURCHASE");
        if (h == 1)
        {
            //TxtFromdate.Text = objCl.GetClosingDate("REFERALBONUS").ToString("dd/MMM/yyyy");
            TxtFromdate.Text = objCl.GetClosingDate("REFERALREPURCHASE").ToString("dd/MMM/yyyy");
