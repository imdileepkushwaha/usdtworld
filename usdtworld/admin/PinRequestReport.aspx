<%@ Page Title="Deposit Request Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="PinRequestReport.aspx.cs" Inherits="admin_PinRequestReport" %>
                                  ...
                                  <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("Image") %>' Height="40px" Width="40px"  /></asp:LinkButton>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Sponser Id">
                                    ...
                                    <asp:TemplateField HeaderText="Amount" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblamount" runat="server" Text='<%#Eval("EpinAmount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>


                                          <asp:TemplateField HeaderText="Plan Name"  Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPlanname" runat="server" Text='<%#Eval("Planname") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                          <asp:TemplateField HeaderText="Plan id"  Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPlanid" runat="server" Text='<%#Eval("PlanId") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                         <asp:TemplateField HeaderText="No. Of Epin">
                                        <ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="amm" runat="server" Text='<%#Eval("Amount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
