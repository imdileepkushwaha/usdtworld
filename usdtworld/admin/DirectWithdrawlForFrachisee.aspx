<%@ Page Title="Withdrawl Request" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="DirectWithdrawlForFrachisee.aspx.cs" Inherits="user_DirectWithdrawlForFrachisee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
     Withdrawl Request Franchisee 
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Withdrawl</a></li>
        <li class="active">Withdrawl Request Franchisee</li>
        ...
        <ContentTemplate>
          ...
          <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Withdrawl Request Franchisee</h3>
            </div>
                   <div class="box-body">
                          <div class="row">
                         <div class="col-md-6">
