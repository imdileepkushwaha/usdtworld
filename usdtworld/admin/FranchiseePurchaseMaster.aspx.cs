...
public partial class FranchiseePurchaseMaster : System.Web.UI.Page
{
    ...
    protected void BtnSubmitPurchase_Click(object sender, EventArgs e)
    {
      ...
      //  objbank.fr
        objbank.UserId = Session["useradmin"].ToString();
        ...
        DataTable Dt = objbank.FranchiseePurchaseByAdmin(objbank, ViewState["PDT"] as DataTable);
