...
public partial class ClosingREportSelfPurchase : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        ...
        DataTable Dt = objCL.getClosingReport(Fromdate, Todatedate, Session["userid"].ToString(), "SELFPURCHASE");
