<%@ Page Title="Transaction Report" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ActivationTransactionReport.aspx.cs" Inherits="admin_UserReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Wallet Transfer Report</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>/</li>
                <li class="fw-medium">Wallet Transaction Report</li>
            </ul>
        </div>
    </section>
