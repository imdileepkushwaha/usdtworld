...
public partial class admin_UserReport : System.Web.UI.Page
{
    ...
    {
        string str_query = "select " + objaccount.NoOfRow + " * from TransactionDetail where   1=1  and Transactiontype in ('P2P Wallet Recieve', 'Wallet Transfer' , 'Wallet Recieve', 'Activate Wallet Transfer','Activate Wallet Recieve')";
    ...
    protected void ExportGridToExcel()
    {
        ...
        Response.Charset = "";
        string FileName = "ActivationTransactionReport_" + DateTime.Now + ".xls";
