            ...
            if (res == "-2")
            {
                ...
                if (res == "-3")
                {
                    ...
                    else
                    {
                        ...
                        string popupScript = "alert('User Added Successfully, UserId is " + res + "');showFranchiseeModal();";
                        ScriptManager.RegisterStartupScript(UpdatePanel1, UpdatePanel1.GetType(), Guid.NewGuid().ToString(), popupScript, true);
    ...
    public void getStatus(int s)
    {
        ...
        try
        {
            ...
            if (dt == null)
            {
                ...
                ScriptManager.RegisterStartupScript(UpdatePanel1, UpdatePanel1.GetType(), Guid.NewGuid().ToString(), "alert('User Added Successfully. UserID is :" + ViewState["UserId"].ToString() + "');location.href='index.aspx';", true);
            }
            else
            {
