<%@ Page Title="Purchase Report" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="UserPvReport.aspx.cs" Inherits="UserPvReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
      <h1>
          User Purchase PV Report
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Accounts</a></li>
        <li class="active">User Purchase PV Report </li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentpageData" runat="Server">
    ...
    <ProgressTemplate>
         <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #000000; opacity: 0.7;">
            <asp:Image ID="imgUpdateProgress" runat="server" ImageUrl="~/img/ajax-loader.gif" AlternateText="Loading ..." ToolTip="Loading ..." style="padding: 10px;position:fixed;top:5%;left:28%;" />
        </div>
    </ProgressTemplate>
</asp:UpdateProgress>
                   ...
                   <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                             ...
                             <div class="form-group">
                                 <label>Level :</label>
                                 <asp:TextBox ID="TxtLevel"  CssClass="form-control" runat="server"></asp:TextBox>
                             </div>
                         </div>
                        </div>
                       </div>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Details</h3>
                   ...
                   <div class="box-body">
                         ...
                         <div class="col-md-12">
                             <div class="form-group">
                                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GV1_DataBound" ShowFooter="true">
                               <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Transaction Id">
                                       ...
                                       <asp:TemplateField HeaderText="From UserId">
                                        <ItemTemplate>
                                            <asp:Label ID="lblfrom" runat="server" Text='<%#Eval("FromUserId") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>             
                                     ...
                                     <asp:TemplateField HeaderText="Date">
                                        <ItemTemplate>
                                            <asp:Label ID="lbldate" runat="server" Text='<%#Eval("CreateDate","{0:dd/MM/yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>  
                                   ...
                                   <asp:TemplateField HeaderText="Self/Team">
                                        <ItemTemplate>
                                            <asp:Label ID="lblemaildd" runat="server" Text='<%#Eval("Status") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>     
