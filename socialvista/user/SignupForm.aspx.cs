...
public partial class user_SignupForm : System.Web.UI.Page
{
        ...
        if (Session["userid"] != null)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    string url = "alert('You cannot upload SignUp Form.Please contact admin.');";
