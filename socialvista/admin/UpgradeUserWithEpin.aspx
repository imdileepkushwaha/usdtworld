<%@ Page Title="Upgrade User With E-Pin" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="UpgradeUserWithEpin.aspx.cs" Inherits="UpgradeUserWithEpin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <h1>Upgrade User With E-Pin 
        </h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="#">My Wallet</a></li>
            <li class="active">Upgrade User With E-Pin</li>
        </ol>
    </section>
</asp:Content>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Upgrade User With E-Pin </h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
