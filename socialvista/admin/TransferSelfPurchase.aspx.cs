...
public partial class TransferSelfPurchase : System.Web.UI.Page
{
    ...
    void loaduser()
    {
        ...
        dt = objCL.getClosingDate("SELFPURCHASE");
    ...
    void loaddata()
    {
        ...
        DataTable Dt = objCL.getClosingReport(Fromdate, Todatedate, TxtUserId.Text, "SELFPURCHASE");
    ...
    protected void btnpay_Click(object sender, EventArgs e)
    {
        ...
        {
            int c = objCL.TransferPayoutSelfPurchase(IdList, UserList, AmountList, MobileList);
            if (c == 1)
            {
                loaddata();
