<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="JoiningClosingReport_Monthly.aspx.cs" Inherits="JoiningClosingReportMonth" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
  <section class="content-header">
     ...
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active">   Monthely Payout</li>
      </ol>
    </section>  
</asp:Content>
                                    ...
                                    <asp:TemplateField HeaderText="To Date">
                                     ...
                                     <asp:TemplateField HeaderText="User Name">
                                       ...
                                       <asp:TemplateField HeaderText="Direct Income">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalleft" runat="server" Text='<%#Eval("DirectIncome") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Award Income">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalleft" runat="server" Text='<%#Eval("awardIncome") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
