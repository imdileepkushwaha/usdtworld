<%@ Page Title="Deposit Request" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="DepositRequstAdd.aspx.cs" Inherits="user_DepositRequstAdd" %>
                   ...
                   <div class="box-body">
                    ...
                    <div class="row" style="display:none;">
                       ...
                       <asp:Panel runat="server" Visible="false" ID="Pnladmin">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <asp:RadioButton ID="RdBtnUtility" runat="server" Text="Shopping Wallet" GroupName="A" AutoPostBack="true" OnCheckedChanged="RdBtnUtility_CheckedChanged"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                </div>
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <span><label>Enter Amount :</label>&nbsp;<asp:Label ID="lblmssg" runat="server" style="font-weight:bold;color:red" Visible="false"></asp:Label></span>
