...
public partial class ActivateUserWithEpin : System.Web.UI.Page
{
        ...
        if (txtuserid.Text != "")
        {
            if (txttransferuserid.Text != "")
            {
                ...
                if (ddepin.SelectedIndex != 0)
                {
                    ...
                    string rs = objUser.activateUserWithEpin(objUser);
                    if (rs == "t")
                    {
