...
public partial class franchiseeDepositRequestReport : System.Web.UI.Page
{
    ...
    void loadgethelp()
    {
        ...
        dt = objaccount.getfranchiseeDepositRequestnew(objaccount);
  ...
  Label LblRequestTo = (Label)gvRow.FindControl("LblRequestTo");    
        ...
        string res = objaccount.Approve_franchiseedepositRequest(objaccount);
        if (res == "t")
        {
