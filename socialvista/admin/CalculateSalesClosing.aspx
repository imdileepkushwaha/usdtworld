<%@ Page Title="Generate Closing" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="CalculateSalesClosing.aspx.cs" Inherits="CalculateSalesClosing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
     <section class="content-header">
      <h1>
      Generate Sales Closing 
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Closing</a></li>
        <li class="active">Generate Sales Closing</li>
      </ol>
    </section>    
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Generate Sales Closing</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
