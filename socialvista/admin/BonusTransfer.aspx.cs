...
public partial class BonusTransfer : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        if (DDlstFromdate.SelectedIndex != 0)
        {
            ...
            DataTable Dt = objCL.getClosingReport(Fromdate, Todatedate,"");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (DDlstFromdate.SelectedIndex != 0)
        {
            ...
            string Fromdate = str[0].ToString();
            string Todatedate = str[1].ToString();
            string res = objCL.UpdateTransfer(Fromdate, Todatedate);
            if (res == "1")
            {
