...
public partial class admin_InvoicePrint : System.Web.UI.Page
{
    ...
    {
        objV.VendorId = "IC000001";
        objV.PurchaseID = "1";
        DataTable dt1 = new DataTable();
        dt1 = objV.getUserPurchasePurchaseforinvoice(objV);
        ...
        LblGTotal.Text = dt1.Rows[0]["TotalAmount"].ToString();
