<%@ Page Title="Level Master" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="FranchiseeCommission.aspx.cs" Inherits="FranchiseeCommission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
    <section class="content-header">
      <h1>
       Franchisee Commission master    
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Utility management</a></li>
        <li class="active"> Franchisee Commission master </li>
      </ol>
    </section>   
</asp:Content>
              ...
              <div class="box-body">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" >
                           ...
                           <asp:TemplateField HeaderText="Type">
                               <ItemTemplate>
                                     <asp:Label ID="lbllevel" runat="server"  Text='<%#Eval("Name") %>'></asp:Label>
                               </ItemTemplate>
                           </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Comission %">
                               <ItemTemplate>
                                   <asp:TextBox ID="txtcomission" CssClass="form-control" Text='<%#Eval("Commission") %>'  runat="server"></asp:TextBox>
                               </ItemTemplate>
                                        </asp:TemplateField>
                            </Columns>
                            </asp:GridView>
