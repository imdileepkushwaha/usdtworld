<%@ Page Title="Purchase Report" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="UserPvReport.aspx.cs" Inherits="UserPvReport" %>
                             ...
                             <div class="form-group">
                               ...
                               <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="Self/Team">
                                        <ItemTemplate>
                                            <asp:Label ID="lblemaild" runat="server" Text='<%#Eval("Status") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>  
