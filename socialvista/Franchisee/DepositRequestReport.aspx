<%@ Page Title="Deposit Request Report" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="DepositRequestReport.aspx.cs" Inherits="admin_DepositRequestReport" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group table-responsive no-padding">
                                     <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-responsive table-hover dataTable" Width="100%" AutoGenerateColumns="False"  OnRowDataBound="grdGetHelp_RowDataBound" OnRowCommand="GridView1_RowCommand" >
                                    <Columns>
