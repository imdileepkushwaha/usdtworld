<%@ Page Title="Transfer E-Pin" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="ActivateUserWithEpin.aspx.cs" Inherits="ActivateUserWithEpin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <h1>Activate User With E-Pin 
        </h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="#">My Wallet</a></li>
            <li class="active">E-Pin Tranfer</li>
        </ol>
    </section>
</asp:Content>
