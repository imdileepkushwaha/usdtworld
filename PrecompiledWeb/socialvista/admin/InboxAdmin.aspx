<%@ page title="Inbox" language="C#" masterpagefile="adminmaster.master" autoeventwireup="true" inherits="Associate_Details, App_Web_whpx20ve" %>
                                    ...
                                    <div class="col-md-12">
                                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound">
                                            ...
                                            <asp:TemplateField HeaderText="Sr.No.">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lbluserid" runat="server" Text='<%# Eval("MentionBy") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
