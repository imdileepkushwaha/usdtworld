<%@ page title="Edit User Details" language="C#" masterpagefile="adminmaster.master" autoeventwireup="true" inherits="admin_UserEdit, App_Web_xaf2lnhz" %>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Adhar :</label>
                                        <asp:TextBox ID="Txtadhar" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
