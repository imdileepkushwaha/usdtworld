<%@ page language="C#" autoeventwireup="true" inherits="MehndilinkInvoice, App_Web_wyzx51io" %>
 ...
 <div class="container">
    ...
    <table style="border-collapse: collapse; margin-right: 10px; flex: 4;">
          ...
          <tr>
              ...
              <td style="width:50%"><img src="../user/img/logo.png" alt="" style="height: 30%; width: 30%; display: inline-block; float:left;"/></td>
               <td style="width:50%"><h4>DIVYA YAJURVEDA WELLNESS PRIVATE LIMITED</h4>
                    <h6>HEAD OFFICE - L-2 278 SECTOR G LDA KNP ROAD,LDA COLONY,LUCKNOW-226012 UTTAR PRADESH, INDIA  <br>
CONTACT – +91 8429123875 <br>EMAIL- Customer@divyayajurvedawellness.com <br>WEBSITE – divyayajurvedawellness.com </h6>
                    <b style="text-align: left; margin-right: 50px;"> COMPANY GSTN - ABC  </b><br />
       <b style="text-align: right;"> COMPANY CIN - ABC </b></td> 
            </tr>
     ...
     <div style="margin-top: 5px;">
          ...
          <div style="background-color:#4800ff; color:#fff; padding:5px">Shipping Address </div>
...
<div style="margin-top: 10px;">
    ...
    TOTAL SV : <asp:Label ID="lblTotalBV" runat="server" Text="Label"></asp:Label> ONLY || 
...
<br />
  ...
  <div style="display: flex; margin-top: 5px;">
    ...
    <table style="border-collapse: collapse; max-width: 500px; flex: 1;">
      ...
      <tr>
        <td style="height: 100px;" class="center"> <br> <br>  </br></br> <b>DIVYA YAJURVEDA WELLNESS PRIVATE LIMITED</b></td>
      </tr>
    </table>
  </div> 
