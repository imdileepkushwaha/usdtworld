<%@ page title="" language="C#" masterpagefile="~/admin/adminmaster.master" autoeventwireup="true" inherits="VendorPurchaseMaster, App_Web_ft3jxdqr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function validate() {
             if (document.getElementById("<%=DDLstVendor.ClientID%>").value == "0") {
                alert('Select Vendor');
                document.getElementById("<%=DDLstVendor.ClientID%>").focus();
                return false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
       Vendor Purchase Master      
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Product management</a></li>
        <li class="active">Vendor Purchase Master </li>
      </ol>
    </section>    
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Vendor Purchase Master</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <label>Product Name :</label> <asp:TextBox ID="TxtProductName" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>          
                                  ...
                                  <div class="col-md-4">
                        <div class="form-group">                         
                        <label>Amount/Pieces :</label> <asp:TextBox ID="TxtAmount" CssClass="form-control" runat="server" onchange="gettotal();"></asp:TextBox>  
                        </div>
                              </div>
                          ...
                          <div class="row">
                               <div class="col-md-3">
                        <div class="form-group">                         
                        <label>Batch Number :</label> <asp:TextBox ID="txtBatchno" CssClass="form-control" runat="server" ></asp:TextBox>     
